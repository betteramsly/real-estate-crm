...
CRM для риелторов и небольших агентств недвижимости. Закрывает базовые рабочие сценарии: ведение клиентов, объектов, сделок и задач, дашборд с KPI и канбан-воронка сделок.
